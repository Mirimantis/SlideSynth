...
export const COMMANDS = [
  ...
  { id: 'transport.jam', label: 'Jam', section: 'Transport', keys: ['J'], once: true,
    description: 'free-running clock: sound on, nothing recorded' },
  ...
  { id: 'transport.escape', label: 'Cancel', section: 'Transport', keys: ['Escape'],
    description: 'stop a count-in, recording or jam; otherwise finish drawing, close the transform box and clear Prism projection' },
  ...
  { id: 'edit.paste', label: 'Paste', section: 'Edit', keys: ['Ctrl+V'], description: 'at the playhead (under the rail with Lock Rail on)' },
